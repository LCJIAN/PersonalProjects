...
@Configuration
@EnableJpaRepositories(basePackages = { "com.lcjian.spunsugar.repository" })
@EnableTransactionManagement
@EnableSpringDataWebSupport
class PersistenceContext {
    private static final String[] ENTITY_PACKAGES = { "com.lcjian.spunsugar.entity" };

    private static final String PROPERTY_NAME_DB_DRIVER_CLASS = "db.driver";
    private static final String PROPERTY_NAME_DB_PASSWORD = "db.password";
    private static final String PROPERTY_NAME_DB_URL = "db.url";
    private static final String PROPERTY_NAME_DB_USER = "db.username";
    private static final String PROPERTY_NAME_DB_MAX_POOL_SIZE = "db.max_pool_size";
    ...
    DataSource dataSource(Environment env) {
        ...
        dataSourceConfig.setMaximumPoolSize(Integer.parseInt(env.getRequiredProperty(PROPERTY_NAME_DB_MAX_POOL_SIZE)));
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Environment env) {
        ...
        jpaProperties.put(PROPERTY_NAME_HIBERNATE_CONNECTION_CHARSET, env.getRequiredProperty(PROPERTY_NAME_HIBERNATE_CONNECTION_CHARSET));
