package com.lcjian.drinkwater.data.network;
...
import com.lcjian.drinkwater.data.network.service.SpunSugarService;
import com.lcjian.drinkwater.util.MD5Utils;
import com.lcjian.drinkwater.util.StorageUtils;
    ...
    private Retrofit getRetrofit() {
        if (retrofit == null) {
            ...
            clientBuilder.interceptors().add(chain -> {
                ...
                String password = MD5Utils.getMD532(username + "key");
