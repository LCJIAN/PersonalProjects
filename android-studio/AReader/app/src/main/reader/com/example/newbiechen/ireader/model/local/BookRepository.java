...
public class BookRepository {
    ...
    public void saveCollBookWithAsync(CollBookBean bean) {
        ...
        bookshelf.bookId = Long.parseLong(bean.get_id());
        bookshelf.bookName = bean.getTitle();
        App.getInstance().getDataBase().bookshelfDao().insert(bookshelf);
    }
    ...
    public void saveBookRecord(BookRecordBean bean) {
        ...
        bookHistory.bookId = Long.parseLong(bean.getBookId());
        bookHistory.chapterIndex = (long) bean.getChapter();
        bookHistory.chapterBegin = (long) bean.getPagePos();
        App.getInstance().getDataBase().bookHistoryDao().insert(bookHistory);
    }
