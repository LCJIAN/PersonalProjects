...
public class VoiceRecorder {
    ...
    private VoiceRecorder(String dirPath) {
        mDirPath = dirPath;
        init();
    }
     ...
     * 单例模式
     */
    public static VoiceRecorder getInstance(String dirPath) {
        if (mInstance == null) {
            synchronized (VoiceRecorder.class) {
                if (mInstance == null) {
                    mInstance = new VoiceRecorder(dirPath);
                }
            }
        }
        return mInstance;
    ...
    public void prepareAudio() {
        try {
            ...
            if (mAudioStateListener != null) {
                mAudioStateListener.preparedDone();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
