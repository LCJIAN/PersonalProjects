package com.lcjian.vastplayer.android.preference;
...
public class FilePickerPreference extends Preference implements
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        final FilePickerPreference.SavedState myState = new FilePickerPreference.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state == null || !(state instanceof FilePickerPreference.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }
        FilePickerPreference.SavedState myState = (FilePickerPreference.SavedState) state;
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<FilePickerPreference.SavedState> CREATOR =
                new Creator<FilePickerPreference.SavedState>() {
