...
public class WConstants {
    ...
    public static class GattConfig {
        ...
        // 开关同步组播地址订阅
        public static final byte[] ATTR_TYPE_GROUP_ADDRESS_SUB = new byte[]{(byte) 0x16, (byte) 0xF0};

        public static final byte[] ATTR_TYPE_GROUP_ADDRESS_SUB_REPLY = new byte[]{(byte) 0x17, (byte) 0xF0};
    }
